          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <Link
                ...
                className="mt-8 inline-flex h-12 items-center justify-center rounded-full bg-[#C4161C] px-10 text-[13px] font-semibold uppercase tracking-[0.14em] text-white transition-all hover:bg-[#e0272d] hover:shadow-lg hover:shadow-[#C4161C]/30 active:scale-[0.97]"
              >
                Voir la chaîne
              </Link>
            </motion.div>
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#C4161C] px-8 text-[13px] font-semibold uppercase tracking-[0.12em] text-white transition-all hover:bg-[#e0272d] hover:shadow-lg hover:shadow-[#C4161C]/30 active:scale-[0.97]"
                >
