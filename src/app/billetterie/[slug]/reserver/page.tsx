                ...
                <div ref={formRef} className="scroll-mt-24 rounded-xl border border-white/10 bg-white/[0.08] p-6 md:p-8 space-y-6">
                  ...
                  <div className="border-t border-white/10 pt-4">
                    ...
                    <p className="mt-3 text-xs text-gray-400">
                      Ta commande est enregistrée avec une référence. En ligne : tu choisis et règles ta catégorie sur la billetterie sécurisée du prestataire. À la livraison : un livreur ou un agent passe encaisser en espèces, puis ton billet numérique t&rsquo;est envoyé. Ta place est confirmée une fois le paiement reçu.
                    </p>
                  </div>
                </div>
              )}
