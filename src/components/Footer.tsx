...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-black py-12 text-gray-300">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 text-gray-300 transition-colors hover:text-[#C9A84C]"
                >
              ...
              {/* Réseaux sociaux */}
              <li className="pt-2">
                <span className="block text-xs font-semibold uppercase tracking-wider text-gray-300 mb-3">
                  Suivez-nous
                </span>
                <div className="flex gap-4">
                  ...
                  <a
                    ...
                    className="text-gray-300 transition-colors hover:text-[#C9A84C]"
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="text-gray-300 transition-colors hover:text-[#C9A84C]"
                    aria-label="Instagram Worship Gift"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6m9.65 1.5a1.25 1.25 0 0 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10m0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/></svg>
                  </a>
                </div>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-white/5 pt-8 text-center text-xs text-gray-300">
          <p>
